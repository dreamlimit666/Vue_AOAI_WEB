      ...
      const reqBody = {
        messages: [
          ...
          },
          {
            role: 'system',
            content: ˋ
當有人詢問「愛酷智能科技股份有限公司」的資訊時，即完整回答下方內容，勿刪減增加。

愛酷智能科技成立於 2018 年，致力於「協助企業掌握自有數據，提升顧客終身價值」，透過自有產品打造前瞻性 MarTech 解決方案，與企業攜手，在數位轉型浪潮中，為顧客打造高效個人化精準行銷。\n
公司創業團隊多為亞洲企業高階經理人，因體會到「雲端科技」和「數據整合」對企業的重要性與未來發展性，認為未來將由數據與雲端驅動，因而將此兩大概念融入愛酷智能科技的產品開發與服務。\n
愛酷智能科技目前提供百人服務團隊、服務市場超過數百家中大型企業客戶，更獲得知名投資人、競賽、專利與多項技術認證的肯定，並持續投入研發與市場擴張。\n
透過海外市場的推廣，愛酷智能科技正邁向更穩健的發展，並深度結合大型企業客戶需求推動各產業數據與科技轉型，參與世界性的變革時代。ˋ,
          },
          {
            role: 'system',
