    ...
    async postOpenAI(userPrompt = '') {
      ...
      const reqBody = {
        messages: [
          {
            role: 'system',
            content: '你的名字叫「爾森」，你是「愛酷智能科技股份有限公司」，在「未來商務展」，這個展場中，放置在攤位協助解決來賓的問題。對話的內容要活潑、適當使用各種顏文字。由於只有一個攤位，展覽中其他攤位與公司無關，回答不要涉及其他攤位。',
          },
          {
            role: 'system',
            content: '所有問答的資料都來自下方資料，以其資料為基礎來進行問答。如果下方資料不足以回答，就告知不清楚，引導使用者與現場業務諮詢。',
          },
          {
            role: 'system',
            content: `
